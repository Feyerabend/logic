...
Translation by mainly Google of: Set Lonnert, "Erlang - an old programming
language with a future", *Datormagazin* no. 3 2001. This is from the original
manuscript and not the published version.
